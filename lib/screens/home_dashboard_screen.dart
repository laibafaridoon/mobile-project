      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Search Bar Card that navigates to doctor search
                  GestureDetector(
                    onTap: () =>
              ...
              child: Row(
                ...
                children: [
                    ...
                    onTap: () {
                      if (activeAppointments.isNotEmpty) {
                        Navigator.pushNamed(
                          context,
                          AppRoutes.liveQueue,
                          arguments: activeAppointments.first.id,
                        );
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('No active appointments to track'),
                          ),
                        );
                      }
                    },
                  ...
                  _buildQuickAction(
                    ...
                    route: AppRoutes.medicineReminder,
                  ),
                  _buildQuickAction(
                    context,
                    label: 'Profile',
            ...
            // Active Queue Ticket / Live Status Card
            if (activeAppointments.isNotEmpty) ...[
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 24.0),
                child: Row(
            ...
            if (activeAppointments.isEmpty)
              Padding(
                ...
                child: _buildEmptyState(
                  context,
                  message: 'No upcoming appointments booked.',
                  actionText: 'Book a Doctor Now',
                  onAction: () =>
            ...
            if (medicines.isEmpty)
              Padding(
                ...
                child: _buildEmptyState(
                  context,
                  message: 'No active medicine reminders.',
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              '${(medicineProvider.dailyProgress * 100).toInt()}% Done',
                              style: const TextStyle(
                                fontWeight: FontWeight.bold,
                                color: AppColors.primary,
                                fontSize: 13,
                        ...
                        ClipRRect(
                          ...
                          child: LinearProgressIndicator(
                            value: medicineProvider.dailyProgress,
                            minHeight: 8,
                            color: AppColors.primary,
                            backgroundColor: AppColors.primaryLight,
                          ),
                        ...
                        ListView.separated(
                          ...
                          itemCount: medicines.length > 3
                              ? 3
                              : medicines.length,
                          separatorBuilder: (_, _) => const Divider(height: 16),
                          itemBuilder: (context, idx) {
                            final med = medicines[idx];
                            final firstSlot = med.takenToday.keys.isNotEmpty
                                ? med.takenToday.keys.first
                                : '';
                            final isTaken = firstSlot.isNotEmpty
                                ? med.takenToday[firstSlot] ?? false
                                : false;
                            return Row(
                              children: [
                                Container(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        firstSlot.isNotEmpty
                                            ? '${med.dosage} • ${med.beforeFood ? "Before Food" : "After Food"}'
                                            : '${med.dosage} • No scheduled slot',
                                        style: const TextStyle(
                                          color: AppColors.textSecondary,
                                          fontSize: 12,
                                        ),
